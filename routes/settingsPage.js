  ...
  res.send(`
    ...
    <body>
      <div class="card">
        ...
        ${merchant.shopify_access_token ? '<span class="connected-badge">✅ Connected</span>' : ''}
        ...
        <div class="info-box">
          ...
          1. Enter your CedaPay API keys (get them from your <a href="https://cedapay.com" target="_blank">CedaPay Dashboard</a>)<br>
          2. Select Test mode while testing, switch to Live when ready<br>
          3. A "Pay with CedaPay" button will appear on your store's cart page
        </div>
      </div>
      
      <script>
        // Initialize Shopify App Bridge (embeds this page in Shopify Admin)
